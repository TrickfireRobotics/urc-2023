...
docker run --mount type=bind,source="$(pwd)",target="/home/trickfire/urc-2023" -itd --privileged --name trickfirerobot --network=host --workdir /home/trickfire/urc-2023 trickfireimage
