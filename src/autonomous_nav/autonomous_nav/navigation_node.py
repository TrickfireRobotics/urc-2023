...
class NavigationNode(Node):
    ...
    def updateNavigation(self) -> None:
        ...
        self.get_logger().info("Updating navigation...")
        if not self.anchor_received:
    ...
    def planPath(
        ...
        while distance_to_goal > 2:
            ...
            next_position: Tuple[float, float] = self.position_to_index(grid, lowest_cost_position)
            target_area = self.collect_area(grid, next_position, search_radius)
