...
class ExampleNode(Node):
    ...
    def __init__(self) -> None:
        ...
        # --- SUBSCRIBER EXAMPLE ---
        self.example_sub = self.create_subscription(String, "example_topic", self.example_sub_callback, 10)
    ...
    def timer_callback(self) -> None:
        ...
        self.get_logger().info("Example timer callback called with motor position " + str(motorPosition))
